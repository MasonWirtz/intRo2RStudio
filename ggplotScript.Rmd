...
df_rating = full_join(read_csv("~/Documents/R/R Projects/DYNSC/Data/Data sets/rating.csv"), read_csv("~/Documents/R/R Projects/DYNSC/Data/Data sets/exposure.csv"), by = "id") %>% 
  mutate(
...
ggs(modFriendly) %>% 
  ...
  geom_vline(xintercept = 0, linetype = "dashed") +
  labs(x = "Logged TCU count values across conditions",
       y = "") +
